        ...
        <form method="POST" action="{{ route('password.update')}}" class="mb-10">   
            ...
            @method('PUT')
                ...
                <div class="relative">
                    ...
                    <button type="button" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-700" onclick="togglePassword('vecchiaPwd')">
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-700" onclick="togglePassword('nuovaPwd')">
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-700" onclick="togglePassword('confermaPwd')">
