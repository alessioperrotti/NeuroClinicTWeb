...
<div class="p-8 max-w-3xl mx-auto bg-white rounded-xl shadow-lg mt-12">
    <form class="mb-10">
        ...
        <br>
        <input type="password" class="bg-cyan-100 w-full my-3 rounded-xl pl-2"></inpunt>
        <br>
        ...
        <div class="mx-56 my-4">
            <input id="annulla" type="submit" value="Annulla" class="cursor-pointer float-left bg-cyan-600 rounded-md py-1 px-2 text-white text-lg hover:bg-cyan-300" ></input>
            <input id="conferma" type="submit" value="Conferma" class="cursor-pointer float-right bg-cyan-600 rounded-md py-1 px-2 text-white text-lg hover:bg-cyan-300"></input>
        </div>
    </form>
</div>
@endsection