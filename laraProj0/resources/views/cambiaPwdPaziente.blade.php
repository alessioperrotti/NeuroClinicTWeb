    ...
    <div class="p-8 max-w-3xl mx-auto bg-white rounded-xl shadow-lg mt-12">
        <form class="mb-10">
            ...
            <div class="flex justify-center mt-4 gap-y-4 4  gap-x-24">
                <input type="reset" value="Annulla Modifiche" class="cursor-pointer bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-400" ></input>
                <input type="submit" value="Conferma Modifiche" class="cursor-pointer bg-cyan-600 text-white py-2 px-4 rounded-md hover:bg-cyan-500"></input>
            </div>
        </form>
    </div>
</div>
